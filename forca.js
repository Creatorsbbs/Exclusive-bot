...
// auto-clean (evita sala presa / memória morta)
const TEMPO_SALA = 1000 * 60 * 30; // 30 min
...
module.exports = (client) => {
  ...
  client.on("interactionCreate", async (i) => {
    ...
    if (i.isStringSelectMenu() && i.customId === "cat") {
      ...
      // auto delete
      setTimeout(() => salas.delete(id), TEMPO_SALA);
    ...
    if (i.customId.startsWith("entrar_")) {
      ...
      if (!j) return i.reply({ content: "❌ Sala expirada ou não encontrada.", ephemeral: true });
